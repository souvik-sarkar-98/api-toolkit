# `@api-toolkit/nestjs-shared-persistence`
...
```bash
npm install @api-toolkit/nestjs-shared-core @api-toolkit/nestjs-shared-persistence
```
...
```bash
npm run build -w @api-toolkit/nestjs-shared-persistence
```
