...
import { BasePrismaService, PRISMA_CLIENT } from '@api-toolkit/nestjs-shared-persistence/prisma/base-prisma.service';
import { DATABASE_OPTIONS } from '@api-toolkit/nestjs-shared-persistence/database-options.token';
