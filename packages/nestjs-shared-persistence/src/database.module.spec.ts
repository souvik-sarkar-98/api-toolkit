...
import { DatabaseModule, DATABASE_OPTIONS } from '@api-toolkit/nestjs-shared-persistence/database.module';
import { PRISMA_CLIENT } from '@api-toolkit/nestjs-shared-persistence/prisma/base-prisma.service';
