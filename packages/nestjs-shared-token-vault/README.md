# `@ssdev-toolkit/nestjs-shared-token-vault`
...
```bash
npm install @ssdev-toolkit/nestjs-shared-core @ssdev-toolkit/nestjs-shared-token-vault
```
...
```bash
npm run build -w @ssdev-toolkit/nestjs-shared-token-vault
```
