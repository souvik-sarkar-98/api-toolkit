jest.mock('@ssdev-toolkit/nestjs-shared-token-vault/infrastructure/providers/google-oauth.provider', () => ({
  GoogleOAuthProvider: class GoogleOAuthProvider { },
}));
jest.mock('@ssdev-toolkit/nestjs-shared-token-vault/infrastructure/providers/microsoft-oauth.provider', () => ({
  MicrosoftOAuthProvider: class MicrosoftOAuthProvider { },
}));
jest.mock('@ssdev-toolkit/nestjs-shared-token-vault/presentation/controllers/oauth.controller', () => ({
  OAuthController: class OAuthController { },
}));

import { TokenVaultModule } from '@ssdev-toolkit/nestjs-shared-token-vault/token-vault.module';
import { OAUTH_PROVIDER_REGISTRY } from '@ssdev-toolkit/nestjs-shared-token-vault/application/ports/oauth-provider.port';
import { TOKEN_VAULT_OPTIONS } from '@ssdev-toolkit/nestjs-shared-token-vault/token-vault-options';
import { GoogleOAuthProvider } from '@ssdev-toolkit/nestjs-shared-token-vault/infrastructure/providers/google-oauth.provider';
import { MicrosoftOAuthProvider } from '@ssdev-toolkit/nestjs-shared-token-vault/infrastructure/providers/microsoft-oauth.provider';
