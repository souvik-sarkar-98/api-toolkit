...
```bash
npm install @ssdev-toolkit/comment-core @ssdev-toolkit/comment-angular
```
...
```ts
import { MENTION_USER_SEARCH } from '@ssdev-toolkit/comment-angular';
...
```bash
npm run build -w @ssdev-toolkit/comment-angular
```
