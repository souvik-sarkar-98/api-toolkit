# `@ssdev-toolkit/list-dashboard-angular`
...
```bash
npm install @ssdev-toolkit/list-dashboard-core @ssdev-toolkit/list-dashboard-angular @ssdev-toolkit/forms-core @ssdev-toolkit/forms-angular
```
...
```typescript
import { UniversalListDashboardModule } from '@ssdev-toolkit/list-dashboard-angular';
...
```css
@import '@ssdev-toolkit/list-dashboard-angular/styles/list-dashboard.tokens.css';
```
