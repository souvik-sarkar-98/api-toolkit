# `@api-toolkit/nestjs-shared-comment`
...
```bash
npm install @api-toolkit/nestjs-shared-core @api-toolkit/nestjs-shared-comment
```
...
```bash
npm run build -w @api-toolkit/nestjs-shared-comment
```
