# `@ssdev-toolkit/nestjs-shared-cron`
...
```bash
npm install @ssdev-toolkit/nestjs-shared-core @ssdev-toolkit/nestjs-shared-cron
```
...
```bash
npm run build -w @ssdev-toolkit/nestjs-shared-cron
```
