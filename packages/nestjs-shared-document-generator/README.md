# `@api-toolkit/nestjs-shared-document-generator`
...
```bash
npm install @api-toolkit/nestjs-shared-document-generator
```
...
```bash
npm run build -w @api-toolkit/nestjs-shared-document-generator
```
