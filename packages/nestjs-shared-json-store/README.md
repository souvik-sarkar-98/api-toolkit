# `@api-toolkit/nestjs-shared-json-store`
...
```bash
npm install @api-toolkit/nestjs-shared-core @api-toolkit/nestjs-shared-json-store
```
...
```bash
npm run build -w @api-toolkit/nestjs-shared-json-store
```
