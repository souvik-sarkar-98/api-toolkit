# @ssdev-toolkit/list-dashboard-core
...
```bash
npm install @ssdev-toolkit/forms-core @ssdev-toolkit/list-dashboard-core
```

Depends on `@ssdev-toolkit/forms-core` for form definitions used in list create/edit/filter.
...
`<na-list-dashboard>` in `@ssdev-toolkit/list-dashboard-angular`.
...
```bash
npm run build -w @ssdev-toolkit/list-dashboard-core
npm test -w @ssdev-toolkit/list-dashboard-core
```

## Consumers

- [`@ssdev-toolkit/list-dashboard-angular`](../list-dashboard-angular/README.md) — Angular host
- `@ssdev-toolkit/list-dashboard-react` — planned
