 ...
 */
import { Notification } from '@api-toolkit/nestjs-shared-correspondence/domain/aggregates/notification.aggregate';
...
import { NotificationCreatedEvent, type NotificationCreatedSnapshot } from '@api-toolkit/nestjs-shared-correspondence/domain/events/notification-created.event';
import { UserNotificationReadEvent, type UserNotificationReadSnapshot } from '@api-toolkit/nestjs-shared-correspondence/domain/events/user-notification-read.event';
import { UserNotificationArchivedEvent, type UserNotificationArchivedSnapshot } from '@api-toolkit/nestjs-shared-correspondence/domain/events/user-notification-archived.event';
import { NotificationPushDeliveredEvent, type NotificationPushDeliveredSnapshot } from '@api-toolkit/nestjs-shared-correspondence/domain/events/notification-push-delivered.event';
import { SubscriptionDeactivatedEvent, type SubscriptionDeactivatedSnapshot } from '@api-toolkit/nestjs-shared-correspondence/domain/events/subscription-deactivated.event';
import { NotificationType } from '@api-toolkit/nestjs-shared-correspondence/domain/enums/notification-type.enum';
