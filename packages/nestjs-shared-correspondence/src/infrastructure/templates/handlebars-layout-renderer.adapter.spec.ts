 ...
 */
import { HandlebarsLayoutRendererAdapter } from '@api-toolkit/nestjs-shared-correspondence/infrastructure/templates/handlebars-layout-renderer.adapter';
import { EmailLayoutData } from '@api-toolkit/nestjs-shared-correspondence/domain/ports/template.port';
import { TemplateNotFoundError } from '@api-toolkit/nestjs-shared-correspondence/domain/errors/correspondence.errors';
import { DEFAULT_EMAIL_THEME } from '@api-toolkit/nestjs-shared-correspondence/email-theme';
import type { CorrespondenceModuleOptions } from '@api-toolkit/nestjs-shared-correspondence/correspondence.schema';
