...
import { SmtpEmailAdapter } from '@ssdev-toolkit/nestjs-shared-correspondence/infrastructure/email/smtp-email.adapter';
import { EmailDeliveryFailedError } from '@ssdev-toolkit/nestjs-shared-correspondence/domain/errors/correspondence.errors';
