 ...
 */
import { EmailDispatchService } from '@ssdev-toolkit/nestjs-shared-correspondence/application/dispatch/email-dispatch.service';
import { ITemplatePort, EmailTemplateData } from '@ssdev-toolkit/nestjs-shared-correspondence/domain/ports/template.port';
import { ILayoutRendererPort } from '@ssdev-toolkit/nestjs-shared-correspondence/domain/ports/layout-renderer.port';
import { IEmailSenderPort, EmailMessage } from '@ssdev-toolkit/nestjs-shared-correspondence/domain/ports/email-sender.port';
