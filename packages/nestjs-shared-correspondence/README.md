# `@api-toolkit/nestjs-shared-correspondence`
...
```bash
npm install @api-toolkit/nestjs-shared-core @api-toolkit/nestjs-shared-queue @api-toolkit/nestjs-shared-correspondence
```
...
```bash
npm run build -w @api-toolkit/nestjs-shared-correspondence
```
