# `@ssdev-toolkit/nestjs-shared-custom-forms`
...
```bash
npm install @ssdev-toolkit/nestjs-shared-core @ssdev-toolkit/nestjs-shared-custom-forms
```

Ruleset JSON (for UI/backend contract): `@ssdev-toolkit/nestjs-shared-custom-forms/schemas/custom-forms.ruleset.json`.
...
```bash
npm run build -w @ssdev-toolkit/nestjs-shared-custom-forms
```
