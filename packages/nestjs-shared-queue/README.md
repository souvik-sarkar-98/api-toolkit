# `@api-toolkit/nestjs-shared-queue`
...
```bash
npm install @api-toolkit/nestjs-shared-core @api-toolkit/nestjs-shared-queue
```
...
```bash
npm run build -w @api-toolkit/nestjs-shared-queue
```
