# `@ssdev-toolkit/nestjs-shared-observability`
...
```bash
npm install @ssdev-toolkit/nestjs-shared-core @ssdev-toolkit/nestjs-shared-observability
```
...
```bash
npm run build -w @ssdev-toolkit/nestjs-shared-observability
```
